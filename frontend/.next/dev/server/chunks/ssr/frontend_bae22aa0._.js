...
function ChatPage() {
    ...
    const handleSendMessage = async (e)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$streamingClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAgentResponse"])(formData, (chunk)=>{
                setMessages((prev)=>{
                    const newMessages = [
                        ...prev
                    ];
