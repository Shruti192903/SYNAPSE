...
export async function detectIntent(message) {
  ...
  if (lower.includes("analyze csv") || lower.includes("trend")) return "analyze_csv";
  if (lower.includes("ocr") || lower.includes("extract text")) return "run_ocr";
  if (lower.includes("summarize") && lower.includes("pdf")) return "summarize_pdf";
